(function(exports,_vendetta,plugin,assets,common,components,storage,commands,Stream,http,Url,require$$0$1,https,zlib,toasts){'use strict';var icons = {
...
function getAugmentedNamespace(n) {
    ...
    return a;
}var dist = {};var sentira_client = {};var nodePonyfill = {exports: {}};function _class_call_check(instance, Constructor) {
...
function _create_class(Constructor, protoProps, staticProps) {
    ...
    return Constructor;
}var publicApi = {};var URL$2 = {exports: {}};var conversions = {};
...
var utilsExports = utils.exports;var URLImpl = {};var urlStateMachine = {exports: {}};var tr46 = {};var require$$1 = [
	[
		[
			0,
			44
...
URLImpl.implementation = /*#__PURE__*/ function() {
    function URLImpl(constructorArgs) {
        _class_call_check(this, URLImpl);
...
// expose Promise
fetch.Promise = global.Promise;var lib=/*#__PURE__*/Object.freeze({__proto__:null,AbortError:AbortError,FetchError:FetchError,Headers:Headers,Request:Request,Response:Response,default:fetch});var require$$0 = /*@__PURE__*/getAugmentedNamespace(lib);(function(module, exports) {
...
var nodePonyfillExports = nodePonyfill.exports;var __awaiter = commonjsGlobal && commonjsGlobal.__awaiter || function(thisArg, _arguments, P, generator) {
...
Object.defineProperty(sentira_client, "__esModule", {
    value: true
});
sentira_client.SentiraAIClient = void 0;
// A shared api client for sentira services
var cross_fetch_1 = nodePonyfillExports;
var SentiraAIClient = /** @class */ function() {
    function SentiraAIClient(apiKey) {
        this.baseUrl = "https://api.sentiraai.com";
        console.info("SentiraAI API initialized");
        this.apiKey = apiKey;
    }
    SentiraAIClient.prototype.summarize = function(body) {
        return __awaiter(this, void 0, void 0, function() {
            var urlRegex, transcription, response, data;
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        console.info("Summarize method called");
                        console.info("Summarize request body: ".concat(JSON.stringify(body)));
                        urlRegex = /(https?:\/\/[^\s]+)/g;
                        if (!urlRegex.test(body.text)) return [
                            3 /*break*/ ,
                            2
                        ];
                        return [
                    ...
                    case 2:
                        return [
                            4 /*yield*/ ,
                            (0, cross_fetch_1.default)("".concat(this.baseUrl, "/summarize"), {
                                method: "POST",
                                headers: {
                    ...
                    case 3:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new Error("Failed to summarize: ".concat(response.statusText));
                        }
                        return [
                            4 /*yield*/ ,
                            response.json()
                    ...
                    case 4:
                        data = _a.sent();
                        console.info("Summarize response: ".concat(JSON.stringify(data)));
                        return [
                            2 /*return*/ ,
                            {
                                result: data.result,
    ...
    SentiraAIClient.prototype.transcribe = function(body) {
        return __awaiter(this, void 0, void 0, function() {
            var response, data;
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        ...
                        console.info("Transcribe request body: ".concat(JSON.stringify(body)));
                        return [
                            4 /*yield*/ ,
                            (0, cross_fetch_1.default)("".concat(this.baseUrl, "/transcribe"), {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "x-api-key": this.apiKey
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new Error("Failed to transcribe: ".concat(response.statusText));
                        }
                        return [
                            4 /*yield*/ ,
                            response.json()
                    ...
                    case 2:
                        data = _a.sent();
                        console.info("Transcribe response: ".concat(JSON.stringify(data)));
                        return [
                            2 /*return*/ ,
                            {
                                result: data.result,
    ...
    SentiraAIClient.prototype.createApiKey = function(body) {
        return __awaiter(this, void 0, void 0, function() {
            var response, data;
            return __generator(this, function(_a) {
                switch(_a.label){
                    case 0:
                        ...
                        return [
                            4 /*yield*/ ,
                            (0, cross_fetch_1.default)("".concat(this.baseUrl, "/api-keys"), {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "x-api-key": this.apiKey
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new Error("Failed to create api key: ".concat(response.statusText));
                        }
                        return [
                            4 /*yield*/ ,
                            response.json()
                    ...
                    case 2:
                        data = _a.sent();
                        console.info("CreateApiKey response: ".concat(JSON.stringify(data)));
                        return [
                            2 /*return*/ ,
                            data.key
                        ];
    ...
    SentiraAIClient.prototype.getApiKeys = function() {
        return __awaiter(this, void 0, void 0, function() {
            var response, data;
            return __generator(this, function(_a) {
                switch(_a.label){
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new Error("Failed to get api keys: ".concat(response.statusText));
                        }
                        return [
                            4 /*yield*/ ,
                            response.json()
                    ...
                    case 2:
                        data = _a.sent();
                        console.info("GetApiKeys response: ".concat(JSON.stringify(data)));
                        return [
                            2 /*return*/ ,
                            data
                        ];
    ...
    return SentiraAIClient;
}();
sentira_client.SentiraAIClient = SentiraAIClient;var types = {};Object.defineProperty(types, "__esModule", {
    value: true
});(function(exports) {
    ...
    __exportStar(sentira_client, exports);
    __exportStar(types, exports);
})(dist);async function getSummary(args) {
  _vendetta.logger.info("SentiraAI getSummary called");
  let client = new dist.SentiraAIClient(plugin.storage["apiKey"]);
...
var index = {
  ...
  settings: Settings
};exports.default=index;exports.settings=settings;Object.defineProperty(exports,'__esModule',{value:true});return exports;})({},vendetta,vendetta.plugin,vendetta.ui.assets,vendetta.metro.common,vendetta.ui.components,vendetta.storage,vendetta.commands,Stream,http,Url,require$$0$1,https,zlib,vendetta.ui.toasts);